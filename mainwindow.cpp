...
void MainWindow::connectSignals()
{
    ...
    connect(buttonRemoveFilter,
            &QPushButton::released,
            this,
            &MainWindow::onReleased_buttonRemoveFilter);
    connect(comboBoxWindow1,
            SIGNAL(currentIndexChanged(int)),
            this,
            SLOT(onChanged_comboBoxWindow1(int)));
    connect(comboBoxWindow2,
            SIGNAL(currentIndexChanged(int)),
            this,
            SLOT(onChanged_comboBoxWindow2(int)));
    connect(listWidgetUsedFilters,
